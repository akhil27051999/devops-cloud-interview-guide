...
Promtail	Reads, labels, and sends logs
Loki	Stores logs
...
Prometheus	Scrapes probe metrics
Grafana	Visualizes uptime & latency
Alertmanager	Sends downtime alerts
Real-world Insight
...
DB Exporter	Provides metrics
Panels	Visualize metrics with alerts
Real-world Insight
...
Filters	Only show application logs
Real-world Insight
...
Summary Table
Component	Role
Prometheus	Evaluate metrics & trigger alert
Alertmanager	Route alerts to Slack
Node Exporter	Collect CPU/memory metrics
...
Summary Table
Component	Role
Prometheus	Monitors metrics and triggers alert
Alertmanager	Routes alert to Slack
Grafana	Visualizes error trends
Real-world Insight
...
Summary Table
Component	Role
Prometheus	Compute latency percentiles
Grafana	Visualize latency trends
Alertmanager	Notify on high latency
Real-world Insight
...
Summary Table
Component	Role
kube-state-metrics	Expose pod restart counts
Prometheus	Monitor metrics and trigger alerts
Grafana	Visualize pod restarts
Alertmanager	Notify teams via Slack
Real-world Insight
...
Summary Table
Metric Type	Purpose
RED	Service-level (API performance)
USE	System/resource-level (CPU, memory, disk)
Real-world Insight
...
Summary Table
Practice	Purpose
Dedicated namespace	Isolation and easier management
PVCs	Persistent storage for metrics/logs
Secrets	Secure sensitive info
DaemonSets	Node-level observability
Real-world Insight
...
Summary Table
Metric	Purpose
CPU	Detect high utilization
Memory	Detect memory pressure
Disk	Detect low disk space
Real-world Insight
...
Summary Table
Metric	Purpose
kube_pod_status_phase	Pod lifecycle monitoring
kube_deployment_status_replicas	Deployment health
kube_pod_container_status_restarts_total	Detect instability
Real-world Insight
...
Summary Table
Metric	Purpose
probe_success	Detect downtime
probe_duration_seconds	Monitor latency
Real-world Insight
...
Summary Table
Metric	Purpose
http_requests_total	Detect sudden traffic spikes
Real-world Insight
...
Summary Table
Feature	Purpose
__path__	Select log files
pipeline_stages	Filter log content
Labels	Categorize logs
Real-world Insight
...
Summary Table
Component	Role
Remote Prometheus	Expose metrics per cluster
Central Prometheus	Aggregate metrics via federation
Grafana	Visualize multi-cluster data
Real-world Insight
...
Summary Table
Practice	Purpose
Sustained threshold	Avoid noise
Relative baseline	Adaptive alerting
Combine metrics	More reliable alerts
Real-world Insight
...
Summary Table
Metric	Purpose
kube_pod_container_status_restarts_total	Detect unstable pods
Real-world Insight
...
Summary Table
Metric	Purpose
pg_replication_lag	Detect replica lag
Real-world Insight
...
Summary Table
Metric	Purpose
probe_success	Endpoint reachability
vault_seal_status	Service health
Real-world Insight
...
Metric	Purpose
probe_success	Detect downtime
probe_duration_seconds	Monitor API latency
Real-world Insight
...
Summary Table
Metric	Purpose
http_requests_total (5xx)	Error monitoring
...
RED	API latency	Service health
USE	CPU, memory	System resource usage
Real-world Insight
...
Summary Table
Parameter	Purpose
storage.tsdb.retention.time	Retention by time
storage.tsdb.retention.size	Retention by size
Compaction	Reduce disk usage
Real-world Insight
...
Labels	Indexing & querying
Chunking & compression	Storage optimization
Real-world Insight
...
Summary Table
Step	Purpose
Helm charts	Deploy observability components
CI/CD pipeline	Automate deployment & updates
Documentation	Guide setup and maintenance
Real-world Insight
